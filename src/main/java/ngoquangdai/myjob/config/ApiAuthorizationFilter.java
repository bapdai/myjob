...
//        Trường joojp client không có request header theo format cần thiết
...
//        Lấy thông tin token từ request header
        try {
//            remove chữ Bearer
...
//            lưu thông tin người dùng đăng nhập vào string context
